...
x, xx, fx, errores, num_iter, convergencia = descenso_newton_exacto(f, df, ddf, x0, alpha, maxIter, tol, criterio_paro)

print("Descenso de gradiente de Newton con Hessiano exacto:")
