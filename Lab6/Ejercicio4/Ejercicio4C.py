...
x1 = pulp.LpVariable("x1", lowBound=0, cat='Integer')  # Casas unifamiliares
x2 = pulp.LpVariable("x2", lowBound=0, cat='Integer')  # Casas dobles
x3 = pulp.LpVariable("x3", lowBound=0, cat='Integer')  # Casas triples
x4 = pulp.LpVariable("x4", lowBound=0, cat='Integer')  # Casas cuádruples
